...
<html>
	...
	<div class="message_header">
		<div class="author" id="author"> <?php echo $msg['username'];?></div>
		<div class="date_time" id="date_time"> <?php echo $msg['msg_date'];?></div>
	</div>
	<div class="message_controls">
		<a href="javascript:;">редактировать</a><a href="javascript:;">ответить</a></div>
	</div> 
